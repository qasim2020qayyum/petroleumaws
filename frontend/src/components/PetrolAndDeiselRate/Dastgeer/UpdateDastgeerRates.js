...
const UpdateDastgeerRates = () => {
  ...
  const getUserDetail = async () => {
    let res = await fetch(`${process.env.REACT_APP_BACKEND_URL_KEY}/joiya/rate/dastgeer/${params.id}`)
    res = await res.json();
  ...
  const updateData = async (e) => {
    ...
    res = await res.json();
    console.log(res);
    navigate('/dastgeer-filling-station');
              ...
              <div className="card-body p-4 p-sm-5">
                ...
                <form>
                  ...
                  <div style={{ textAlign: "center" }}>
                    <Link to="/dastgeer-filling-station">
...
export default UpdateDastgeerRates;
