...
const EditDastgeer = () => {
    ...
    const getUserDetail = async () => {
        let res = await fetch(`${process.env.REACT_APP_BACKEND_URL_KEY}/joiya/dastgeer/data/${params.id}`)
        res = await res.json();
        ...
        setcreditPayment(res.creditPayment)
        setmiscPayment2(res.miscPayment2)
    ...
    const updateData = async (e) => {
        ...
        res = await res.json();
        console.log(res);
        navigate('/dastgeer-filling-station/get-all-data');
    ...
    return (
        <>
            <div className="form-container card border-0 shadow rounded-3 my-5 p-5">
                <h1 className="mb-5">Dastgeer Filling Station</h1>
                <hr />
                <form>
                    {/* sup 1 */}
                    ...
                    <div className="form-row">
                        ...
                        <div className="form-group">
                            ...
                            <input type="number" required value={creditPayment} onChange={(e) => setcreditPayment(e.target.value)} />
                        </div>
                        <div className="form-group">
                            <label htmlFor="name">Misc Payment</label>
                            <input type="number" required value={miscPayment2} onChange={(e) => setmiscPayment2(e.target.value)} />
                        </div>
