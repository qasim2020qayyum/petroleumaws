...
const UpdateAwanBrotherRates = () => {
  ...
  const getUserDetail = async () => {
    let res = await fetch(`${process.env.REACT_APP_BACKEND_URL_KEY}/joiya/rate/awanbrothers/${params.id}`)
    res = await res.json();
...
export default UpdateAwanBrotherRates;
