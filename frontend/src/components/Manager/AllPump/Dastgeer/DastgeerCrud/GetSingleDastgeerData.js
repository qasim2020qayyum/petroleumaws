...
const GetSingleDastgeerData = () => {
  ...
  const generatePDF = useReactToPrint({
    ...
    documentTitle: "Dastgeer Filling Station",
        ...
        <div ref={componentPDF} style={{ textAlign: "center", width: "100%" }}>
          <div>
            ...
            <div className='headcss_2'>
              <p>Station: Dastgeer Filling Station</p>
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td >{aliPetroliumPump.creditPayment}</td>
                  <td >{aliPetroliumPump.miscPayment2}</td>
...
export default GetSingleDastgeerData
