...
const UpdateTakhatMahalRates = () => {
  ...
  const getUserDetail = async () => {
    let res = await fetch(`${process.env.REACT_APP_BACKEND_URL_KEY}/joiya/rate/takhatMahal/${params.id}`)
    res = await res.json();
...
export default UpdateTakhatMahalRates;
