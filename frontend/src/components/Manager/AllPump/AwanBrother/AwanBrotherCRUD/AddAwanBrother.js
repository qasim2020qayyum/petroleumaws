...
const AddAwanBrother = () => {
    ...
    const userData = async () => {
        let res = await fetch(`${process.env.REACT_APP_BACKEND_URL_KEY}/joiya/awanbrothers/data`)
        res = await res.json();
    ...
    const [hsd5_difference, setHsd5difference] = useState('');
    const [hsd6_difference, setHsd6difference] = useState('');
    useEffect(() => {
        ...
        setHsd5difference(hsd5_currentReading-lastReadingHsd5)
        setHsd6difference(hsd6_currentReading-lastReadingHsd6)
        userData()
        petrol()
        ...
        <>
            <div className="form-container card border-0 shadow rounded-3 my-5 p-5">
                ...
                <form>
                    ...
                    <div className="form-row">
                        <div className="form-group">
                            <h3 style={{ marginTop: "3rem" }}>HSD5 <span className="text-danger"> Difference: {hsd5_difference}</span></h3>
                        </div>
                        <div className="form-group">
                            <label htmlFor="name">Last Reading</label>
                    ...
                    <div className="form-row">
                        <div className="form-group">
                            <h3 style={{ marginTop: "3rem" }}>HSD6 <span className="text-danger"> Difference: {hsd6_difference}</span></h3>
                        </div>
                        <div className="form-group">
                            <label htmlFor="name">Last Reading</label>
