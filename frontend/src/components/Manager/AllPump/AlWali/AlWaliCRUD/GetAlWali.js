...
console.log(uData)
  ...
  return (
    <div>
        <h1 className='display-0 fw-bold my-4 text-danger'>AL Wali Power Station</h1>
        <hr />
                ...
                return(
                    <>
                        <tr key={user._id}>
                            ...
                            <td>
                                <Link to={`/edit-al-wali-power-station-data/${user._id}`} className='btn btn-success btn-sm me-2'><i class="fas fa-edit"></i></Link> 
