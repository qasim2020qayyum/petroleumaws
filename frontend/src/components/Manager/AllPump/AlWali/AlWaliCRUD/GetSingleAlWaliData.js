...
const pumpData = async() =>{
    let res = await fetch(`${process.env.REACT_APP_BACKEND_URL_KEY}/joiya/alwali/data/${id}`)
    res = await res.json();    
 ...
 const generatePDF= useReactToPrint({
    ...
    documentTitle: "AlWaliPowerStation",
  ...
  return (
    ...
    <div>
        ...
        <div className='headcss_2'>
            <p>Station: AL Wali Power Station</p>
...
export default GetSingleAlWaliData
