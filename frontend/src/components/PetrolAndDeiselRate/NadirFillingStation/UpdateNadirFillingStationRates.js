...
const UpdateNadirFillingStationRates = () => {
  ...
  const getUserDetail = async () => {
    let res = await fetch(`${process.env.REACT_APP_BACKEND_URL_KEY}/joiya/rate/nadirFillingStations/${params.id}`)
    res = await res.json();
  ...
  const updateData = async (e) => {
    ...
    res = await res.json();
    console.log(res);
    navigate('/nadir-filling-station');
...
export default UpdateNadirFillingStationRates;
