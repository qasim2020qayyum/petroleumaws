...
const FirstAddAliPetrolium = () => {
    ...
    const petrol = async () => {
      ...
      res = await res.json();
    //   setPetrolPurchaseRate(res[res.length - 1].sup_purchase_rate)
    //   setPetrolSaleRate(res[res.length - 1].sup_sale_rate)
    //   setDeiselPurchaseRate(res[res.length - 1].hsd_purchase_rate)
    //   setDeiselSaleRate(res[res.length - 1].hsd_sale_rate)
                ...
                <form> 
                    {/* <div className="form-row"> 
                        ...
                        <div className="form-group">
                            ...
                            <input type="number" id="name" name="name" required value={petrolPurchaseRate} onChange={(e) => setSupPurchaseRate(e.target.value)} />
                        ...
                        <div className="form-group">
                            ...
                            <input type="number" id="name" name="name" required value={petrolSaleRate} onChange={(e) => setSupSaleRate(e.target.value)} />
                        ...
                        <div className="form-group">
                            ...
                            <input type="number" id="name" name="name" required value={deiselPurchaseRate} onChange={(e) => setHsdPurchaseRate(e.target.value)} />
                        ...
                        <div className="form-group">
                            ...
                            <input type="number" id="name" name="name" required value={deiselSaleRate} onChange={(e) => setHsdSaleRate(e.target.value)} />
