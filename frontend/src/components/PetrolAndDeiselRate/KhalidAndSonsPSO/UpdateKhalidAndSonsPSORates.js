...
const UpdatekhalidAndSonServiceRates = () => {
  ...
  const getUserDetail = async () => {
    let res = await fetch(`${process.env.REACT_APP_BACKEND_URL_KEY}/joiya/rate/khalidAndSon/${params.id}`)
    res = await res.json();
...
export default UpdatekhalidAndSonServiceRates;
