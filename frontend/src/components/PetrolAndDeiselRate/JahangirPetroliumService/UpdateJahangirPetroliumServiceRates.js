...
const UpdateJahangirPetroliumServiceRates = () => {
  ...
  const getUserDetail = async () => {
    let res = await fetch(`${process.env.REACT_APP_BACKEND_URL_KEY}/joiya/rate/jahangirPetrolium/${params.id}`)
    res = await res.json();
  ...
  const updateData = async (e) => {
    ...
    res = await res.json();
    console.log(res);
    navigate('/jahangir-petrolium-service');
              ...
              <div className="card-body p-4 p-sm-5">
                ...
                <form>
                  ...
                  <div style={{ textAlign: "center" }}>
                    <Link to="/jahangir-petrolium-service">
...
export default UpdateJahangirPetroliumServiceRates;
