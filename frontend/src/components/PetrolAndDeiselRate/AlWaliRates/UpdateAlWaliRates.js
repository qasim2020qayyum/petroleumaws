...
const UpdateAlWaliRates = () => {
  ...
  const getUserDetail = async () => {
    let res = await fetch(`${process.env.REACT_APP_BACKEND_URL_KEY}/joiya/rate/alwali/${params.id}`)
    res = await res.json();
  ...
  const updateData = async (e) => {
    ...
    res = await res.json();
    console.log(res);
    navigate('/al-wali-power-station');
...
export default UpdateAlWaliRates;
