...
const UpdateAlSiddiqueFillingStationRates = () => {
  ...
  const getUserDetail = async () => {
    let res = await fetch(`${process.env.REACT_APP_BACKEND_URL_KEY}/joiya/rate/alSiddique/${params.id}`)
    res = await res.json();
  ...
  const updateData = async (e) => {
    ...
    res = await res.json();
    console.log(res);
    navigate('/al-siddique-filling-station');
              ...
              <div className="card-body p-4 p-sm-5">
                ...
                <form>
                  ...
                  <div className="d-grid">
                    <button
                      className="btn btn-light text-light login btn-login  fw-bold"
                  ...
                  <div style={{ textAlign: "center" }}>
                    <Link to="/al-siddique-filling-station">
...
export default UpdateAlSiddiqueFillingStationRates;
