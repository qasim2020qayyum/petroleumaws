...
import GetBabaFareedFillingStaionRates from '../../../PetrolAndDeiselRate/BabaFareedFillingStaion/GetBabaFareedFillingStaionRates'
...
const BabaFareedFillingStaion = () => {
  return (
    <>
    <GetBabaFareedFillingStaionRates/>
