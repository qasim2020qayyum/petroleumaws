const Pump = require("../models/dastgeer")



exports.addDastgeerData = async (req, res) => {
...
// get 
exports.getDastgeerData = async (req, res) => {
    let pumpData = await Pump.find()
    if (pumpData.length > 0) {
        res.send(pumpData)
    } else {
...
//  get in reverse
exports.getDastgeerDataa = async (req, res) => {
    try {
...
exports.getDastgeerDataDetails = async (req, res) => {
...
// update 
exports.updateDastgeerData = async (req, res) => {
...
// delete
exports.deleteDastgeer = async (req, res) => {
    // res.send(req.params)
