...
const AddNadirFillingStationRates = () => {
...
//   const [data, setData] = useState([]);
  ...
  const saveData = async (e) => {
      ...
      e.preventDefault();
      let pumpData = await fetch(`${process.env.REACT_APP_BACKEND_URL_KEY}/joiya/rate/nadirFillingStations/`,  {
          method: 'POST',
          body: JSON.stringify({
              // rates 
...
export default AddNadirFillingStationRates;
