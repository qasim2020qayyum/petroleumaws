const Pump = require("../models/takhatMahal")



exports.addTakhatMahalData = async (req, res) => {
...
// get 
exports.getTakhatMahalData = async (req, res) => {
  let pumpData = await Pump.find()
  if (pumpData.length > 0) {
    res.send(pumpData)
  } else {
...
//  get in reverse
exports.getTakhatMahalDataa = async (req, res) => {
  try {
...
exports.getTakhatMahalDataDetails = async (req, res) => {
...
// update 
exports.updateTakhatMahalData = async (req, res) => {
...
// delete
exports.deleteTakhatMahal = async (req, res) => {
  // res.send(req.params)
