const Pump = require("../models/alwali")
const Rates = require("../models/later/rateSchemaAlWali")



exports.addAlWaliData = async (req, res) => {
    ...
    if (pumpData.length === 0) {
      const {
        ...
        lastReadingSup1, lastReadingSup2, lastReadingSup3, lastReadingSup4, preClosing, lastReadingHsd1, lastReadingHsd2,lastReadingHsd3,lastReadingHsd4
      } = req.body;
      ...
      try {
        ...
        const newPumpData = new Pump({
          ...
          lastReadingHsd1, lastReadingHsd2,lastReadingHsd3,lastReadingHsd4, lastReadingSup1, lastReadingSup2, lastReadingSup3, lastReadingSup4,
          ...
          // computer sale 
          comSaleSup1, comSaleSup2, comSaleSup3, comSaleSup4, comSalehsd1, comSalehsd2,comSalehsd3,comSalehsd4,
      ...
      const {
        ...
        hsd1_currentReading, hsd2_currentReading,hsd3_currentReading,hsd4_currentReading,
        // get super and hsd rate 
        sup_purchase_rate, sup_sale_rate, hsd_purchase_rate, hsd_sale_rate,
        // recieving 
        creditWasoli, lubricants, tucShop, cashFromOtherPumps,
...
// get 
exports.getAlWaliData = async (req, res) => {
  let pumpData = await Pump.find()
  if (pumpData.length > 0) {
    res.send(pumpData)
  } else {
...
//  get in reverse
exports.getAlWaliDataa = async (req, res) => {
  try {
...
exports.getAlWaliDataDetails = async (req, res) => {
...
// update 
exports.updateAlWaliData = async (req, res) => {
...
// delete
exports.deleteAlWali = async (req, res) => {
  // res.send(req.params)
