...
const GetBabaFareedFillingStaionRates = () => {
            ...
            return (
              ...
              <div className="box-containerr" key={item._id}>
                ...
                <div className="rate_box">
                  ...
                  <Link to={`/edit-baba-fareed-filling-station-rates/${item._id}`} style={{position:"absolute", left:"5.2rem", top:"11.5rem"}} className='btn btn-success btn-sm me-2 mt-5'><i class="fas fa-edit"></i></Link>
              </div>
              </>
            )
          })
...
export default GetBabaFareedFillingStaionRates
