...
const AddNoorPetrolium = () => {
    ...
    const saveData = async (e) => {
        ...
        e.preventDefault();
        let pumpData = await fetch(`${process.env.REACT_APP_BACKEND_URL_KEY}/joiya/noorPetrolium/data/`, {
            method: 'POST',
            body: JSON.stringify({
    ...
    const userData = async () => {
        let res = await fetch(`${process.env.REACT_APP_BACKEND_URL_KEY}/joiya/noorPetrolium/data`)
        res = await res.json();
