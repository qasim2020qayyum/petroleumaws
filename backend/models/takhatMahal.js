...
const takhatMahalSchema = new mongoose.Schema({
    // sup current rading 
    sup1_currentReading: {
        type: Number,
        required: true,
    ...
    miscPayment2: {       // payment
        type: Number,
        required: true,
    },
    // totalPayment = psoCard + HBLCard + bankDeposit + psoPayment + advanceSalary  creditPayment , miscPayment2 ,
...
module.exports = mongoose.model("TakhatMahal", takhatMahalSchema)